...
#   print(key.title()+"'s favorite book is "+favorite_books[key])
...
print(address_book.contacts[0]["name"]+ " can be reached at " + address_book.contacts[0]["phone"])
...
for i in range(0,len(address_book.contacts)):
  print(address_book.contacts[i]["name"]+ " can be reached at " + address_book.contacts[i]["phone"])
...
phone_numbers = []
for i in range(0,len(address_book.contacts)):
  phone_numbers.append(address_book.contacts[i]["phone"])
print(phone_numbers)
...
edu_email=[]
for i in range(0,len(address_book.contacts)):
  if(address_book.contacts[i]["email"][len(address_book.contacts[i]["email"])-4:]==".edu"):
    edu_email.append(address_book.contacts[i]["email"])
print(edu_email)  